...
exports.up = function(knex) {
    return knex.raw(`
          ...
          GRANT USAGE ON SCHEMA auth TO users;
...
exports.down = function(knex) {
    return knex.raw(`
        REVOKE CREATE, USAGE ON SCHEMA auth FROM admin;
        REVOKE CREATE, USAGE ON SCHEMA public FROM admin;
        REVOKE CREATE, USAGE ON SCHEMA logging FROM admin;
        REVOKE CREATE, USAGE ON SCHEMA analytics FROM admin;
        REVOKE CREATE, USAGE ON SCHEMA auth FROM migrator;
        REVOKE CREATE, USAGE ON SCHEMA public FROM migrator;
        REVOKE CREATE, USAGE ON SCHEMA logging FROM migrator;
        REVOKE CREATE, USAGE ON SCHEMA analytics FROM migrator;
        ...
        REVOKE USAGE ON SCHEMA auth FROM users;
